...
})))->withContext('twig.template_cache_warmer', $this), new \Symfony\Bundle\TwigBundle\TemplateIterator(($this->services['kernel'] ?? $this->get('kernel')), 'C:\\Pedidos\\src', array('C:\\Pedidos/templates' => NULL, 'C:\\Pedidos\\vendor\\symfony\\twig-bridge/Resources/views/Form' => NULL)));
